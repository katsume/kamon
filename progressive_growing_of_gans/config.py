...
data_dir = './Dropbox/_/kamon/src/book/2-png'
result_dir = './Dropbox/_/kamon/dst/book/pggan-tkarras'
...
random_seed = int(datetime.now().microsecond)
...
# Dataset (choose one).
desc += '-kamon';            dataset = EasyDict(tfrecord_dir='260ppi-tfrecords')
...
# Resume
# train.resume_run_id = './Dropbox/_/kamon/dst/book/pggan-tkarras/002-pgan-kamon-preset-v2-1gpu-fp32/network-snapshot-009000.pkl';
# train.resume_kimg = 9000

#----------------------------------------------------------------------------
# Utility scripts.
# To run, uncomment the appropriate line and launch train.py.

# train = EasyDict(func='util_scripts.generate_fake_images', run_id=3, num_pngs=1000); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
# train = EasyDict(func='util_scripts.generate_fake_images', run_id=3, grid_size=[15,8], num_pngs=10, image_shrink=4); num_gpus = 1; desc = 'fake-grids-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=3, grid_size=[1, 1], num_mp4s=10, duration_sec=32.0, smoothing_sec=4.0, random_seed=random_seed); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
